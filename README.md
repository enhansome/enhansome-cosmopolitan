...
* [Cosmopolitan](https://github.com/jart/cosmopolitan) ⭐ 21,279 | 🐛 227 | 🌐 C | 📅 2026-07-20 - Build-once-run-anywhere for C
...
* [actually portable awk](https://justine.lol/awk/) - The One True \[Portable] [Awk](https://github.com/onetrueawk/awk) ⭐ 2,226 | 🐛 15 | 🌐 C | 📅 2026-08-19
* [bob](https://github.com/dinosaure/bob) ⭐ 143 | 🐛 19 | 🌐 OCaml | 📅 2025-05-12 - A peer-to-peer file-transfer tool in OCaml with Cosmopolitan
* [ffl](https://github.com/nuwainfo/ffl) ⭐ 105 | 🐛 4 | 🌐 Python | 📅 2026-09-12 - Turns any file or folder into a secure HTTPS link, allowing two computers to simply and securely transfer files using real peer-to-peer (WebRTC) connections
...
* [microwindows](https://github.com/ghaerr/microwindows) ⭐ 857 | 🐛 24 | 🌐 C | 📅 2026-09-03 - The Nano-X Window System ([demo](https://github.com/jart/cosmopolitan/issues/35#issuecomment-1098659862) ⭐ 21,279 | 🐛 227 | 🌐 C | 📅 2026-07-20)
...
Note: Some ports are experimental. The most battle-tested code is in the [Cosmopolitan repo](https://github.com/jart/cosmopolitan) ⭐ 21,279 | 🐛 227 | 🌐 C | 📅 2026-07-20. Ports are often a stepping stone for what we put in the monorepo.
...
* [mruby](https://github.com/mruby/mruby) ⭐ 5,609 | 🐛 0 | 🌐 C | 📅 2026-09-12 - mruby [supports cosmo](https://github.com/mruby/mruby/pull/6681) ⭐ 5,609 | 🐛 0 | 🌐 C | 📅 2026-09-12 as a build target
