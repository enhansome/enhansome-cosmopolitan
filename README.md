...
* [Cosmopolitan](https://github.com/jart/cosmopolitan) ⭐ 21,268 | 🐛 225 | 🌐 C | 📅 2026-07-20 - Build-once-run-anywhere for C
...
* [ffl](https://github.com/nuwainfo/ffl) ⭐ 103 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - Turns any file or folder into a secure HTTPS link, allowing two computers to simply and securely transfer files using real peer-to-peer (WebRTC) connections
...
* [microwindows](https://github.com/ghaerr/microwindows) ⭐ 858 | 🐛 24 | 🌐 C | 📅 2026-08-24 - The Nano-X Window System ([demo](https://github.com/jart/cosmopolitan/issues/35#issuecomment-1098659862) ⭐ 21,268 | 🐛 225 | 🌐 C | 📅 2026-07-20)
...
Note: Some ports are experimental. The most battle-tested code is in the [Cosmopolitan repo](https://github.com/jart/cosmopolitan) ⭐ 21,268 | 🐛 225 | 🌐 C | 📅 2026-07-20. Ports are often a stepping stone for what we put in the monorepo.

* [wasm3](https://github.com/wasm3/wasm3/blob/main/docs/Installation.md#cosmopolitan--actually-portable-executable) ⭐ 8,012 | 🐛 20 | 🌐 C | 📅 2026-09-01 - APE of wasm3
* [mruby](https://github.com/mruby/mruby) ⭐ 5,606 | 🐛 4 | 🌐 C | 📅 2026-09-01 - mruby [supports cosmo](https://github.com/mruby/mruby/pull/6681) ⭐ 5,606 | 🐛 4 | 🌐 C | 📅 2026-09-01 as a build target
