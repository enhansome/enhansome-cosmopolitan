...
* [Cosmopolitan](https://github.com/jart/cosmopolitan) ⭐ 21,258 | 🐛 223 | 🌐 C | 📅 2026-07-20 - Build-once-run-anywhere for C
...
* [microwindows](https://github.com/ghaerr/microwindows) ⭐ 854 | 🐛 24 | 🌐 C | 📅 2026-08-24 - The Nano-X Window System ([demo](https://github.com/jart/cosmopolitan/issues/35#issuecomment-1098659862) ⭐ 21,258 | 🐛 223 | 🌐 C | 📅 2026-07-20)
...
Note: Some ports are experimental. The most battle-tested code is in the [Cosmopolitan repo](https://github.com/jart/cosmopolitan) ⭐ 21,258 | 🐛 223 | 🌐 C | 📅 2026-07-20. Ports are often a stepping stone for what we put in the monorepo.

* [wasm3](https://github.com/wasm3/wasm3/blob/main/docs/Installation.md#cosmopolitan--actually-portable-executable) ⭐ 8,002 | 🐛 29 | 🌐 C | 📅 2026-08-26 - APE of wasm3
* [mruby](https://github.com/mruby/mruby) ⭐ 5,600 | 🐛 2 | 🌐 C | 📅 2026-08-26 - mruby [supports cosmo](https://github.com/mruby/mruby/pull/6681) ⭐ 5,600 | 🐛 2 | 🌐 C | 📅 2026-08-26 as a build target
