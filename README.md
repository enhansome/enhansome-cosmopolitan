...
* [Cosmopolitan](https://github.com/jart/cosmopolitan) ⭐ 21,295 | 🐛 228 | 🌐 C | 📅 2026-07-20 - Build-once-run-anywhere for C
...
* [actually portable awk](https://justine.lol/awk/) - The One True \[Portable] [Awk](https://github.com/onetrueawk/awk) ⭐ 2,228 | 🐛 15 | 🌐 C | 📅 2026-08-19
* [bob](https://github.com/dinosaure/bob) ⭐ 143 | 🐛 19 | 🌐 OCaml | 📅 2025-05-12 - A peer-to-peer file-transfer tool in OCaml with Cosmopolitan
* [ffl](https://github.com/nuwainfo/ffl) ⭐ 105 | 🐛 3 | 🌐 Python | 📅 2026-09-20 - Turns any file or folder into a secure HTTPS link, allowing two computers to simply and securely transfer files using real peer-to-peer (WebRTC) connections
...
* [microwindows](https://github.com/ghaerr/microwindows) ⭐ 858 | 🐛 23 | 🌐 C | 📅 2026-09-14 - The Nano-X Window System ([demo](https://github.com/jart/cosmopolitan/issues/35#issuecomment-1098659862) ⭐ 21,295 | 🐛 228 | 🌐 C | 📅 2026-07-20)
* [cosmofy](https://github.com/metaist/cosmofy) ⭐ 108 | 🐛 3 | 🌐 Python | 📅 2026-01-13 - Bundle Python projects into a single-file Cosmopolitan Python executable
...
Note: Some ports are experimental. The most battle-tested code is in the [Cosmopolitan repo](https://github.com/jart/cosmopolitan) ⭐ 21,295 | 🐛 228 | 🌐 C | 📅 2026-07-20. Ports are often a stepping stone for what we put in the monorepo.

* [wasm3](https://github.com/wasm3/wasm3/blob/main/docs/Installation.md#cosmopolitan--actually-portable-executable) ⭐ 8,029 | 🐛 19 | 🌐 C | 📅 2026-09-19 - APE of wasm3
* [mruby](https://github.com/mruby/mruby) ⭐ 5,610 | 🐛 1 | 🌐 C | 📅 2026-09-20 - mruby [supports cosmo](https://github.com/mruby/mruby/pull/6681) ⭐ 5,610 | 🐛 1 | 🌐 C | 📅 2026-09-20 as a build target
...
* [soakbean](https://github.com/coderofsalvation/soakbean) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2026-08-24 write serverlogic using beautiful reactive (nodejs) express-like middleware.
...
* [Fullmoon](https://github.com/pkulchenko/fullmoon) ⭐ 757 | 🐛 8 | 🌐 Lua | 📅 2026-09-19 - Fast and minimalistic web framework
