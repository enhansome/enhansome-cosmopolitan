...
* [Cosmopolitan](https://github.com/jart/cosmopolitan) ⭐ 21,284 | 🐛 228 | 🌐 C | 📅 2026-07-20 - Build-once-run-anywhere for C
...
* [ffl](https://github.com/nuwainfo/ffl) ⭐ 105 | 🐛 3 | 🌐 Python | 📅 2026-09-12 - Turns any file or folder into a secure HTTPS link, allowing two computers to simply and securely transfer files using real peer-to-peer (WebRTC) connections
...
* [microwindows](https://github.com/ghaerr/microwindows) ⭐ 857 | 🐛 23 | 🌐 C | 📅 2026-09-14 - The Nano-X Window System ([demo](https://github.com/jart/cosmopolitan/issues/35#issuecomment-1098659862) ⭐ 21,284 | 🐛 228 | 🌐 C | 📅 2026-07-20)
...
Note: Some ports are experimental. The most battle-tested code is in the [Cosmopolitan repo](https://github.com/jart/cosmopolitan) ⭐ 21,284 | 🐛 228 | 🌐 C | 📅 2026-07-20. Ports are often a stepping stone for what we put in the monorepo.

* [wasm3](https://github.com/wasm3/wasm3/blob/main/docs/Installation.md#cosmopolitan--actually-portable-executable) ⭐ 8,027 | 🐛 18 | 🌐 C | 📅 2026-09-15 - APE of wasm3
* [mruby](https://github.com/mruby/mruby) ⭐ 5,609 | 🐛 0 | 🌐 C | 📅 2026-09-15 - mruby [supports cosmo](https://github.com/mruby/mruby/pull/6681) ⭐ 5,609 | 🐛 0 | 🌐 C | 📅 2026-09-15 as a build target
