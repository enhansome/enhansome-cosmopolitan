...
* [Cosmopolitan](https://github.com/jart/cosmopolitan) ⭐ 21,308 | 🐛 229 | 🌐 C | 📅 2026-07-20 - Build-once-run-anywhere for C
...
* [microwindows](https://github.com/ghaerr/microwindows) ⭐ 858 | 🐛 23 | 🌐 C | 📅 2026-09-14 - The Nano-X Window System ([demo](https://github.com/jart/cosmopolitan/issues/35#issuecomment-1098659862) ⭐ 21,308 | 🐛 229 | 🌐 C | 📅 2026-07-20)
...
Note: Some ports are experimental. The most battle-tested code is in the [Cosmopolitan repo](https://github.com/jart/cosmopolitan) ⭐ 21,308 | 🐛 229 | 🌐 C | 📅 2026-07-20. Ports are often a stepping stone for what we put in the monorepo.

* [wasm3](https://github.com/wasm3/wasm3/blob/main/docs/Installation.md#cosmopolitan--actually-portable-executable) ⭐ 8,034 | 🐛 18 | 🌐 C | 📅 2026-09-25 - APE of wasm3
* [mruby](https://github.com/mruby/mruby) ⭐ 5,613 | 🐛 0 | 🌐 C | 📅 2026-09-25 - mruby [supports cosmo](https://github.com/mruby/mruby/pull/6681) ⭐ 5,613 | 🐛 0 | 🌐 C | 📅 2026-09-25 as a build target
