...
* [Cosmopolitan](https://github.com/jart/cosmopolitan) ⭐ 21,311 | 🐛 229 | 🌐 C | 📅 2026-07-20 - Build-once-run-anywhere for C
...
* [actually portable awk](https://justine.lol/awk/) - The One True \[Portable] [Awk](https://github.com/onetrueawk/awk) ⭐ 2,229 | 🐛 15 | 🌐 C | 📅 2026-08-19
...
* [microwindows](https://github.com/ghaerr/microwindows) ⭐ 859 | 🐛 23 | 🌐 C | 📅 2026-09-14 - The Nano-X Window System ([demo](https://github.com/jart/cosmopolitan/issues/35#issuecomment-1098659862) ⭐ 21,311 | 🐛 229 | 🌐 C | 📅 2026-07-20)
...
Note: Some ports are experimental. The most battle-tested code is in the [Cosmopolitan repo](https://github.com/jart/cosmopolitan) ⭐ 21,311 | 🐛 229 | 🌐 C | 📅 2026-07-20. Ports are often a stepping stone for what we put in the monorepo.

* [wasm3](https://github.com/wasm3/wasm3/blob/main/docs/Installation.md#cosmopolitan--actually-portable-executable) ⭐ 8,035 | 🐛 18 | 🌐 C | 📅 2026-09-25 - APE of wasm3
* [mruby](https://github.com/mruby/mruby) ⭐ 5,613 | 🐛 0 | 🌐 C | 📅 2026-09-26 - mruby [supports cosmo](https://github.com/mruby/mruby/pull/6681) ⭐ 5,613 | 🐛 0 | 🌐 C | 📅 2026-09-26 as a build target
...
* [Fullmoon](https://github.com/pkulchenko/fullmoon) ⭐ 758 | 🐛 8 | 🌐 Lua | 📅 2026-09-22 - Fast and minimalistic web framework
